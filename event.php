...
if(isset($_POST['submit'])) {
    ...
    // var_dump($user);
    // die;
    // $recipient_email = 'ashish.yatharthriti@gmail.com';
    // $subject = 'Contact Us';
...
$message = 'Dear ' . $user->firstname . ', welcome to our Moodle platform. We are excited to have you on board.';
$from_address = 'krishan.yatharthriti@gmail.com';

// Call the function
email_to_user($user, $from_address, $subject, $message);
...
@media (max-width: 480px) {
  ...
  <body>
    <div class='modal-div'> Mail sent successfully</div>
    <div class="container">
