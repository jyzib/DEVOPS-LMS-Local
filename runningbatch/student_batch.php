    ...
    <div class="col-7">
        ...
        <div class="box1">
          ...
          <div class="div">
              ...
              <p class="date" >Batch Start Date <br> <span class="dep">'.$course_stat_date.'(weekday)...</span> </p>
            </div>
             <div class="div">
       ...
       <div class="col-5">
        ...
        <div class="box2">
            ...
            <p class="line-dep" >Lorem ipsum dolor sit amet, qui officia deserunt mollit anim id est laborum.dolor sit amet, qui officia deserunt mollit </p>
            <a href="'.$zoom_meeting->join_url.'" class="btns btn" target="new" >Start  Class</a>
            </div>
           ...
           <div class="div1">
            ...
            <p class="line-dep" >Lorem ipsum dolor sit amet, qui officia deserunt mollit anim id est laborum.dolor sit amet, qui officia deserunt mollit </p>
            <a href="'.$CFG->wwwroot.'/local/runningbatch/course_curriculum.php?groupid='.$groupid.'" class="btns btn">Show Curriculm</a>
            </div>
