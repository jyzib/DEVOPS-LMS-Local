...
class test_table extends table_sql {
     ...
     function __construct($uniqueid)
    {
        ...
        $columns = array('date', 'batch_name','course', 'invoice', 'paid_amount','advance','file','pay_list');
        $this->define_columns($columns);

        // Define the titles of columns to show in header.
        $headers = array('Date', 'Batch Name', 'Course', 'Invoice', 'Paid Amount', 'Advance', 'File', 'Pay List');
