...
require_once(__DIR__.'/payment_history_table.php');
...
$PAGE->requires->css("/local/runningbatch/css/payment.css");
...
if (!$table->is_downloading()) {
    ...
    echo '<div class="card p-3"><form method="get" id="table-invoice-paid"  class="mb-5">
        ...
        <input type="submit" value="Filter" Class="submit btn btn-dark">
        <a href="'.$CFG->wwwroot.'/local/runningbatch/view_invoice_paid.php"><input type="button" value="Reset" Class="reset btn btn-dark"></a>
        </div>
   </form>';
}
$params = [
...
$table->out($perpage, true);
    ...
    echo '<b><label for="perpage">Records per page:</label></b>';
